...
console.log('3. isGreaterThan:', isGreaterThan(2,3));
...
function bigBird(word){
  if(word.length === 3){
    ...
    return 'Nice try Sucka!';
  }
}

console.log(bigBird('cup'));
...
console.log('11. daClub:', daClub(22,22));
...
console.log('12. graduation:', graduation(120, false));
console.log(graduation(90, true));
...
console.log('moneyTrain:', moneyTrain(75));
